    ...
    <div class="content">
      <div class="wrap">
        ...
        <div class="main">
          ...
          <div class="info">
            <a href="#" class="play" @click.prevent="playSong">播放</a>
            <a href="#" class="add"></a>
...
export default {
  ...
  computed: {
    ...
    handelpicUrl() {
      return this.details.al ?  `${this.details.al.picUrl}?param=130y130` : null;
    }
  },
  filters: {
    handelTime(value) {
  ...
  methods: {
    ...
    playSong() {
      this.$store.commit('resetSop')
      this.$store.commit('load', this.songUrl);
      this.$store.commit('setCurrentSong', this.details);
    },
    initData() {
      this.getLyric();
